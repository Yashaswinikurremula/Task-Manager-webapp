...
<html>
    ...
    <body>
        ...
        <div class="all-lists">
            ...
            <a class="btn-primary" href="<?php echo SITEURL; ?>add_lists.php">Add List</a>
                        ...
                        if($count_rows>0)
                        {
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITEURL; ?>update_lists.php?list_id=<?php echo $list_id; ?>">Update</a> 
                                        <a href="<?php echo SITEURL; ?>delete_lists.php?list_id=<?php echo $list_id; ?>">Delete</a>
                                    </td>
                                </tr>
