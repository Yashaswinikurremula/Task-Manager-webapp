<?php 
    ...
    if(isset($_GET['list_id']))
    {
        ...
        else
        {
            ...
            header('location:'.SITEURL.'manage_lists.php');
        }
    }
...
<html>
    ...
    <body>
        ...
        <h1>TASK MANAGER</h1>
            ...
            <a class="btn-secondary" href="<?php echo SITEURL; ?>manage_lists.php">Manage Lists</a>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            header('location:'.SITEURL.'update_lists.php?list_id='.$list_id);
        }
